...
case8: nop
clear
store (0xabcd, -8000, 0x32a4)		# need to be fixed
...
case17: nop
clear
store (0xabcd, -8000, 0x35b0)		# need to be fixed
initial 0x35b0 0			# need to be fixed
jalr $3 $1
nop
addiu $4 $4 2
label17: lhu $4 -7996($3)
nop
...
case36:
clear
initial 0x3ce0 0			# need to be fixed
mtc0 $1 $14
mfc0 $3 $14
nop
nop
...
case37:
clear
initial 0x3d3c 0			# need to be fixed
mtc0 $1 $14
mfc0 $3 $14
nop
nop
